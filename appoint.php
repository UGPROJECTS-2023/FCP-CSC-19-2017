...
<style type="text/css">
    ...
    background: linear-gradient(rgba(0,0,0,0.5), #000), url('assets/img/1703386860_ngate.jpg');
        ...
        <header class="intro">
            <div class="container h-100">
                <div class="row h-100 align-items-center justify-content-center text-center">
                    <div class="col-lg-10">
                    	<h3 class="text-white"><span class="fa fa-stethoscope"></span> Available Doctor(s)</h3>
        	...
        	<div class="card">
				...
				<div class="row align-items-center">
					...
					<div class="col-md-6">
						 ...
						 <p><small><a href="javascript:void(0)" class="view_schedule" data-id="<?php echo $row['id'] ?>" data-name="<?php echo "Dr. ".$row['name'].', '.$row['name_pref'] ?>"><i class='fa fa-calendar animated wobble delay infinite'></i> Click to view Schedule</a></b></small></p>
						 <p><b>Specialties:</b></p>
